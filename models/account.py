...
class Account():
    ...
    account_number = get_last_account_number()
    
    def __init__(self, account_number: int = account_number, name : str = '', last_name: str = '', \
                client_id: str = '', birth_date: str = '', address: str = ''):
        
        self.__account_number = account_number + 1
        self.__name = name
    ...
    def deposit_money(self):
        try:
            ...
            if check_if_account_exists(account_for_deposit):
    ...
    def withdraw_money(self):
        try:
            ...
            if check_if_account_exists(account_to_withdraw):
                ...
                try:
                    ...
                    if value <= 0:
                        ...
                        if check_sufficient_funds(account_to_withdraw, value):
                            self.__balance -= value
    ...
    def transfer_money(self):
        try:
            ...
            if check_if_account_exists(source_account_number):
                if check_if_account_exists(target_account_number):
                    ...
                    try:
                        ...
                        if check_sufficient_funds(self.account_number, transaction_value):
                    ...
                    print(f'\nTarge account {target_account} is not registered')    
            else:
                print(f'\nSource account {self.__account_number} is not registered')
